...
<head>
    ...
    <title>PDFH5</title>
    <link rel="stylesheet" href="{{asset('pdfh5/css/style.css')}}" />
    <link rel="stylesheet" href="{{asset('pdfh5/css/pdfh5.css')}}" />
...
<script src="{{asset('pdfh5/js/jquery-1.11.3.min.js')}}" type="text/javascript" charset="utf-8"></script>
